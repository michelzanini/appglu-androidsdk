...
/**
 * This class was copied from Ice Cream Sandwich to make it possible to execute tasks with a serial thread pool executor on Android versions before HONEYCOMB.
 */
