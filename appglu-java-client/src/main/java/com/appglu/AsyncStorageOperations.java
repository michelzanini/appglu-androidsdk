...
public interface AsyncStorageOperations {
	 ...
	 * @see {@link StorageOperations#streamStorageFile(StorageFile, InputStreamCallback)}
	 */
	 ...
	 * @see {@link StorageOperations#streamStorageFileIfModifiedSince(StorageFile, InputStreamCallback)}
	 */
	 ...
	 * @see {@link StorageOperations#streamStorageFileIfNoneMatch(StorageFile, InputStreamCallback)}
	 */
